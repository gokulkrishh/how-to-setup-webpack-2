...
1. [Create Folder] (#step-1)
1. [Install webpack] (#step-2)
1. [Write webpack config] (#step-3)
1. [Run the webpack] (#step-4)
1. [Setup webpack development server] (#step-5)
1. [Run development server] (#step-6)
